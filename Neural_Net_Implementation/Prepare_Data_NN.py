...
pickle.dump([test_y_sound, test_y_noise, test_x, train_y_sound,train_y_noise,train_x, val_y_sound,val_y_noise,val_x], open(file_name+'_auto_Normal_Abnormal_unbalanced.p', 'wb'), protocol=2)
