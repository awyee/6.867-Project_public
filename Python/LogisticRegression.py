...
train_x = train[data.feature_names['auto']].values.astype(float)
val_x = val[data.feature_names['auto']].values.astype(float)
...
#
# score = dict()
# score['train'] = logreg.score(train_x,train_y)
# score['test'] = logreg.score(test_x,test_y)
#
# print('Train Score: ',score['train'])
